...
export default function sitemap(): MetadataRoute.Sitemap {
  const updated = new Date('2026-09-09T00:00:00.000Z')
  ...
  return [
    ...
    { url: `${CANONICAL_APP_URL}/tools/sat-error-log-template`, lastModified: updated, changeFrequency: 'monthly', priority: 0.9 },
    ...
    { url: `${CANONICAL_APP_URL}/guides/how-long-to-study-for-the-sat`, lastModified: updated, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${CANONICAL_APP_URL}/about`, lastModified: updated, changeFrequency: 'monthly', priority: 0.6 },
