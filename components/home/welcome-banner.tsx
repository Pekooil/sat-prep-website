  ...
  return (
    <div className="mt-5">
      ...
      <div className="relative h-3 rounded-full bg-white/15 overflow-visible">
        <div
          className="absolute inset-y-0 left-0 rounded-full bg-gradient-to-r from-violet-300 to-indigo-300"
      ...
      <div className="relative mt-2 h-4">
        {milestoneLabels.map(label => (
          <span
            key={label}
            className="absolute text-[10px] text-violet-300 -translate-x-1/2 font-mono tabular-nums"
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-0 top-0 opacity-10 pointer-events-none" aria-hidden="true">
        ...
        <img
          src="/saturn-mark-white.svg"
          alt=""
          className="h-48 w-48 -translate-y-8 translate-x-8"
        />
      </div>
      ...
      <div className="relative">
          ...
          <div className="shrink-0 flex items-center gap-1.5 rounded-xl bg-white/15 px-3 py-2 backdrop-blur-sm">
            ...
            {streak > 0 ? (
              <div className="text-right">
                <p className="text-base font-bold leading-none text-white font-mono tabular-nums">{streak}</p>
        ...
        {days !== null ? (
          <div className="mt-3 flex items-center gap-2">
            <CalendarDays className="h-4 w-4 text-violet-200 shrink-0" />
            <span className="text-sm text-violet-100">
              {days > 0 ? (
                <>
                  <span className="font-bold text-white font-mono tabular-nums">{days}</span>
